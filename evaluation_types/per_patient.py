# --------------------------------------------------------
# SPCNNet per patient evaluation
...
from utils.util_functions import prepare_data, evaluate_classifier, patient_lesion_classifier_no_sextant, \
    generate_lesions
...
def evaluate_per_patient(mode, path_dict, output_filepath, folds, lr, bx_lesions=False):
    ...
    for volume_thresh in volume_thresholds:
        ...
        stats = evaluate_classifier(total_model_true_grade, total_model_pred_grade,
                                    [SPCNet().agg_threshold])  # , pred_thresh=total_model_pred_thresh)
